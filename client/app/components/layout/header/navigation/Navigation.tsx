...
export default function Navigation({
  ...
  return (
    ...
    >
{mainNav.map((navItem) => {
  const locale = useLocale();  // ← Voeg deze regel toe
  const currentHref = navItem.href[locale as 'nl' | 'en'];  // ← Voeg deze regel toe
  const isActive = isActiveRoute(pathname, currentHref);  // ← Wijzig dit
